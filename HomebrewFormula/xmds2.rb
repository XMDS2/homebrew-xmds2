...
class Xmds2 < Formula
  desc ""
  homepage ""
  url "https://downloads.sourceforge.net/project/xmds/xmds-2.3.0-rc1.tar.gz"
  sha256 "0a0f64ef6f12f24e8f2622e82315064d1ba8fbd9abf8606ac63bf5aadb998bd6"
  ...
  resource "numpy" do
    url "https://pypi.python.org/packages/93/48/956b9dcdddfcedb1705839280e02cbfeb2861ed5d7f59241210530867d5b/numpy-1.16.3.zip"
